...
for i = 1 : numel(backPropDepth)
    net = loadnet(fullfile(sprintf('../output/basic_4/backPropDepth-%d/', ...
    ...
    opts.expDir = fullfile(sprintf('../output/basic_5/backPropDepth-%d/', ...
        backPropDepth(i)));
