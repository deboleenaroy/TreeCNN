...
%l_matrix = likelihood_calculation(net,cifar_100_imdb,new_labels);
...
%         l_matrix = likelihood_calculation(net,cifar_100_imdb,new_labels);
%         [value, index] = sort(l_matrix,'descend');
%         save(fullfile(next_node.filePath, 'l_matrix.mat'), 'l_matrix','value','index');
%         next_node.labelsTransform = grow_tree_2(value, index, next_node.labelsTransform, new_labels);
        ...
        next_node.opts.learningRate = [0.1*ones(1,150), 0.01*ones(1,50), 0.001*ones(1,50)];
