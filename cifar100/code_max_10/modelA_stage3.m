...
opts.batchSize = 20;
opts.numEpochs = 250;
opts.learningRate = [0.1*ones(1,150), 0.01*ones(1,50), 0.001*ones(1,50)];
...
for i = 1 : numel(backPropDepth)
    net = loadnet(fullfile(sprintf('../output/basic_2/backPropDepth-%d/', ...
    ...
    opts.expDir = fullfile(sprintf('../output/basic_3/backPropDepth-%d/', ...
        backPropDepth(i)));
