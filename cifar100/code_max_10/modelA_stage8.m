...
for i = 1 : numel(backPropDepth)
    net = loadnet(fullfile(sprintf('../output/basic_7/backPropDepth-%d/', ...
    ...
    opts.expDir = fullfile(sprintf('../output/basic_8/backPropDepth-%d/', ...
        backPropDepth(i)));
