...
if exist('/data/roy77/Tree_CNN/cifar100/code_v2/imdb_v0.mat','file')
      load '/data/roy77/Tree_CNN/cifar100/code_v2/imdb_v0.mat';
else
    imdb = create_reduced_imdb_for_cifar100(cifar_100_imdb, labelsTransform);
    save('/data/roy77/Tree_CNN/cifar100/code_v2/imdb_v0.mat','imdb')
end
