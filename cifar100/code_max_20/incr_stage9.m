...
oldPath = './output/tree_8/';
newPath = './output/tree_9/' ;
...
new_labels = [78;40;15;59;19;11;70;33;87;28];
...
top_node.opts.numEpochs = 200;
top_node.opts.learningRate = [0.1*ones(1,50), 0.05*ones(1,50), 0.01*ones(1,50), 0.005*ones(1,50), 0.001*ones(1,50)];
...
for i = 1:N
    ...
    if numel(labels) == 1
        ...
        if numel(labels) == numel(labels_old)
            ...
            next_node.opts.learningRate = [0.1*ones(1,50), 0.05*ones(1,50), 0.01*ones(1,50), 0.005*ones(1,50)];
